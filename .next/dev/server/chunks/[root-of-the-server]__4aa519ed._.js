...
"[project]/Documents/GitHub/ThangBackend/pages/api/presence/heartbeat.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        let decodedToken;
        try {
            decodedToken = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ThangBackend$2f$lib$2f$firebaseAdmin$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].auth().verifyIdToken(token);
        } catch (e) {
            return res.status(401).json({
                error: "Invalid token"
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4aa519ed._.js.map