...
"[project]/Documents/GitHub/ThangBackend/pages/api/party/settings.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!privacy || privacy !== "public" && privacy !== "private") {
            return res.status(400).json({
                error: "Invalid privacy setting. Use 'public' or 'private'."
            });
        }
        // 2. Connect to DB
        ...
        if (party.leaderUid !== uid) {
            return res.status(403).json({
                error: "Only the leader can change settings"
            });
        }
        // 5. Update Settings
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5760a24c._.js.map