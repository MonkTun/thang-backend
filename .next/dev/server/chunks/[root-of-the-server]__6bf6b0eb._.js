...
"[project]/Documents/GitHub/ThangBackend/pages/api/party/join.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!party) {
            ...
            await users.updateOne({
                ...
                $pull: {
                    partyInvites: {
                        partyId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$2c$__$5b$project$5d2f$Documents$2f$GitHub$2f$ThangBackend$2f$node_modules$2f$mongodb$29$__["ObjectId"](partyId)
                    }
                }
            });
        ...
        const hasInvite = user.partyInvites?.some((inv)=>inv.partyId.toString() === partyId);
        if (!isPublic && !hasInvite) {
            return res.status(403).json({
                error: "This party is private. You need an invite."
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6bf6b0eb._.js.map