...
"[project]/Documents/GitHub/ThangBackend/pages/api/auth/bootstrap.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        if (!user) {
            ...
            try {
                ...
                if (insertError.code === 11000) {
                    console.log("[Bootstrap] Race condition detected, fetching user again");
        ...
        console.error("[Bootstrap] CRITICAL ERROR:", error instanceof Error ? error.message : String(error));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3915afa._.js.map