...
"[project]/Documents/GitHub/ThangBackend/pages/api/party/status.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (user.partyId) {
            const party = await parties.findOne({
                _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$2c$__$5b$project$5d2f$Documents$2f$GitHub$2f$ThangBackend$2f$node_modules$2f$mongodb$29$__["ObjectId"](user.partyId)
            });
            if (party) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc465be4._.js.map