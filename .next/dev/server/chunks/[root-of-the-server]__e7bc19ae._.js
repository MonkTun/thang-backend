...
"[project]/Documents/GitHub/ThangBackend/pages/api/party/invite.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        const party = await parties.findOne({
            _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$2c$__$5b$project$5d2f$Documents$2f$GitHub$2f$ThangBackend$2f$node_modules$2f$mongodb$29$__["ObjectId"](currentUser.partyId)
        });
        if (!party) {
            // Inconsistency fix
        ...
        if (party.members.length >= 5) {
            return res.status(400).json({
                error: "Party is full (max 5 members)"
            });
        }
        // 4. Find Target User
        ...
        const existingInvite = targetUser.partyInvites?.find((inv)=>inv.partyId.toString() === party._id.toString());
        if (existingInvite) {
            return res.status(400).json({
        ...
        return res.status(200).json({
            message: `Invited ${targetUsername}`
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e7bc19ae._.js.map