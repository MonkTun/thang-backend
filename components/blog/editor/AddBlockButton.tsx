...
import { useMirrorLibrary } from "@/components/blog/MirrorLibraryContext";
      ...
      {open &&
        ...
        createPortal(
          <div
            ...
            // Portalled to <body>, outside the editor's `tw-reset` root.
            className="tw-reset fixed -translate-x-1/2 z-100 bg-surface border border-border rounded-md p-2 w-72 shadow-2xl"
          >
