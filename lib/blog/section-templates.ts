import type { Block, Section } from "@/lib/blog/schema";
...
export const sectionTemplates: SectionTemplate[] = [
  ...
  },
  {
    id: "editorial-hero",
    label: "Big statement",
    description: "Oversized headline + supporting body text. Magazine cover energy.",
    preview: {
      w: 12,
      h: 12,
      blocks: [
  ...
  },
  {
    id: "post-intro",
    label: "Post header",
    description: "Kicker, the post's h1 title and opening paragraph over a rule.",
    preview: {
      w: 12,
      h: 10,
      blocks: [
        { x: 1, y: 0, w: 3, h: 1, tone: "muted" },
        { x: 1, y: 2, w: 9, h: 3, tone: "fg" },
        { x: 1, y: 6, w: 7, h: 3, tone: "muted" },
      ],
    },
    build: () => ({
      background: { type: "transparent" },
      ...
      blocks: [
        ...
        {
          type: "text",
          layout: { col: 2, colSpan: 10, row: 3, rowSpan: 7 },
          props: {
            content: "Where this post starts.",
            variant: "h1",
            align: "left",
            color: "foreground",
          },
        ...
        {
          type: "text",
          layout: { col: 2, colSpan: 8, row: 10, rowSpan: 6 },
          props: {
            content:
              "Open with the one paragraph that earns the scroll — what changed, why it matters, and what the rest of the post walks through.",
            variant: "body",
            align: "left",
            color: "foreground",
          },
        ...
        {
          type: "line",
          layout: { col: 2, colSpan: 10, row: 17, rowSpan: 1 },
          props: { thickness: 1, color: "border" },
        },
      ],
    }),
  },
  {
    id: "video",
    label: "Video",
    description: "One full-width video — YouTube or an uploaded file.",
    preview: {
      w: 12,
      h: 8,
      blocks: [{ x: 0, y: 0, w: 12, h: 8, tone: "fg" }],
    },
    build: () => ({
      background: { type: "transparent" },
      padding: "lg",
      ...
      blocks: [
        {
          type: "video",
          layout: { col: 1, colSpan: 12, row: 1, rowSpan: 27 },
          props: {
            source: "youtube",
            url: "",
            src: "",
  ...
  },
  {
    id: "gallery",
    label: "Gallery",
    description: "Three-up image grid — drop screenshots in, one per tile.",
    preview: {
      w: 12,
      h: 6,
      blocks: [
        { x: 0, y: 0, w: 4, h: 6, tone: "fg" },
        { x: 4, y: 0, w: 4, h: 6, tone: "muted" },
        { x: 8, y: 0, w: 4, h: 6, tone: "fg" },
      ],
    },
    build: () => ({
      background: { type: "transparent" },
      ...
      blocks: [
        {
          type: "projectGrid",
          layout: { col: 1, colSpan: 12, row: 1, rowSpan: 30 },
          // Phones stack the tiles — same override the registry seeds.
          mobile: { props: { columns: 1 } },
          props: {
            items: [
              {
                src: "",
